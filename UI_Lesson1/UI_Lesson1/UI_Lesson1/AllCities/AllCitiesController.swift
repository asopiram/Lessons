...
class AllCitiesController: UITableViewController {
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        ...
        return 1//нужна хотя бы одна секция
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "CityCell", for: indexPath) as! AllCitiesCell // Получаем ячейку из пула
        let city = cities[indexPath.row]// Получаем город для конкретной строки
        cell.cityName.text = city// Устанавливаем город в надпись ячейки
